...
-(MessageFriendCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    MessageFriendCell *cell=[tableView dequeueReusableCellWithIdentifier:@"mesFriendCell"];
