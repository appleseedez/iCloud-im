...
// 常量定义
#define PRESENT_CALLING_VIEW_NOTIFICATION                                      \
  @"PRESENT_CALLING_VIEW_NOTIFICATION" // 通知加载"拨号中"界面
#define PRESENT_ANSWERING_VIEW_NOTIFICATION                                    \
  @"PRESENT_ANSWERING_VIEW_NOTIFICATION" // 通知加载“待接听”界面
#define PRESENT_INSESSION_VIEW_NOTIFICATION                                    \
  @"PRESENT_INSESSION_VIEW_NOTIFICATION"   // 通知加载“通话中界面”
#define PARSED_DATA_KEY @"PARSED_DATA_KEY" //数据暂存池的key
#define DIALING_SOUND_ID 1152              //拨号的声音

#define SERVER_HEART @"SERVER_HEART"
#define SEND_HEART_TO_SERVER @"SEND_HEART_TO_SERVER"
#define SEND_AUTH_TO_SIGNAL_SERVER @"SEND_AUTH_TO_SIGNAL_SERVER"
#define PRESENT_DIAL_VIEW_NOTIFICATION @"PRESENT_DIAL_VIEW_NOTIFICATION" //
#define PEER_FOUND_NOTIFICATION @"PEER_FOUND_NOTIFICATION"
#define NO_CONNECTION_NOTIFICATION @"NO_CONNECTION_NOTIFICATION"
#define CHANGE_CONNECTION_NOTIFICATION @"CHANGE_CONNECTION_NOTIFICATION"
#define CLOSE_REMOTE_VIEW_FOR_RELAY_TRANSPORT                                  \
  @"CLOSE_REMOTE_VIEW_FOR_RELAY_TRANSPORT"
#define UDP_LOOKUP_COMPLETE_NOTIFICATION                                       \
  @"UDP_LOOKUP_COMPLETE_NOTIFICATION" // udp查询完成,应该能够获得信令服务器地址
#define DATA_RECEIVED_NOTIFICATION @"DATA_RECEIVED_NOTIFICATION" // 收到通知标识
#define SESSION_INITED_NOTIFICATION                                            \
  @"SESSION_INITED_NOTIFICATION" // 收到通话查询响应
#define SESSION_PERIOD_NOTIFICATION                                            \
  @"SESSION_PERIOD_NOTIFICATION" // 收到通话查询响应

#define SESSION_PERIOD_CALLING_COME_NOTIFICATION                               \
  @"SESSION_PERIOD_CALLING_COME_NOTIFICATION" // 通知被叫接收
#define SESSION_PERIOD_ANSWERING_COME_NOTIFICATION                             \
  @"SESSION_PERIOD_ANSWERING_NOTIFICATION" // 通知主叫接收
#define SESSION_PERIOD_HALT_NOTIFICATION                                       \
  @"SESSION_PERIOD_HALT_NOTIFICATION" // 收到拒绝通话的响应
#define SESSION_PERIOD_REQ_NOTIFICATION                                        \
  @"SESSION_PERIOD_REQ_NOTIFICATION" // 收到通话请求
#define SESSION_PERIOD_RES_NOTIFICATION                                        \
  @"SESSION_PERIOD_RES_NOTIFICATION" // 收到通话响应
#define CMID_APP_LOGIN_SSS_NOTIFICATION                                        \
  @"CMID_APP_LOGIN_SSS_NOTIFICATION" // 收到信令服务器验证回复
#define END_SESSION_NOTIFICATION @"END_SESSION_NOTIFICATION" //终止会话
#define SIGNAL_ERROR_NOTIFICATION                                              \
  @"SIGNAL_ERROR_NOTIFICATION" //收到异常信令数据
#define DROPPED_FROM_SIGNAL_NOTIFICATION                                       \
  @"DROPPED_FROM_SIGNAL_NOTIFICATION" //被踢下线通知
...
#define CMID_APP_DROPPED_SSS_REQ_TYPE                                          \
  0x00000006 // 当客户端被踢下线时,会收到信令服务器的通知.
#define SESSION_PERIOD_PROCEED_TYPE 1024 //表明发送的是通话链接类型
                                         //是SESSION_PERIOD的子类型。因为会出现发送通话链接请求，而对方回复通话拒绝的情况
...
#define ROUTE_SERVER_PORT                                                      \
  9000 // 通话模块会先绑定登陆服务器的9000端口,用于请求路由,网关服务器的地址.
